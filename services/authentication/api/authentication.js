            ...
            server.register({
                    ...
                    options: {
                        ...
                        handlers: {
                            'v1': {
                                'signIn': {
                                    $post: requestHandlerFactory('post', 'signIn')
                                },
                                'signUp': {
                                    $post: requestHandlerFactory('post', 'signUp')
                                },
                                'signOut': {
                                    $delete: requestHandlerFactory('delete', 'signOut')
                                },
                                'forgotPassword': {
                                    $post: requestHandlerFactory('post', 'forgotPassword')
                                },
                                'changePassword': {
                                    $put: requestHandlerFactory('put', 'changePassword')
                                },
                                'resetPassword': {
                                    $put: requestHandlerFactory('put', 'changePassword')
                                },
                                'validateResetToken': {
                                    $post: requestHandlerFactory('post', 'validateResetPasswordToken')
                                }
                            }
                        }
                    }
