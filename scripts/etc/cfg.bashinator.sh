...
export __ScriptSubCommandLogDir="${__ScriptPath}/logs/" # default: /var/log
...
[[ "$DEBUG" == "1" ]] && export __PrintDebug=1   # default: 0
...
## default: "syslog:user"
export __LogTarget="file:${__ScriptPath}/logs/${__ScriptName}.log:append,file:${__ScriptPath}/logs/${__ScriptName}-current.log:overwrite"
